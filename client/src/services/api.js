...
export const analyticsAPI = {
  ...
  getSectionComparison: (days, startDate, endDate) => api.get('/analytics/section-comparison', { params: { days, startDate, endDate } }),
  ...
  getDepartments: (days, startDate, endDate) => api.get('/analytics/departments', { params: { days, startDate, endDate } }),
