...
const BulkEditModal = ({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center overflow-y-auto bg-black/60 p-3 backdrop-blur-sm sm:p-5"
      onClick={onClose}
    >
      <div
        ref={dialogRef}
        ...
        tabIndex={-1}
        className="w-full max-w-3xl rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-800"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                {leaders
                  .filter((l) => !targetSection || l.section_id === parseInt(targetSection))
                  .map((l) => (
        ...
        <div className="modal-footer">
          ...
          >
            {saving ? (
              ...
              <>
                <Check className="w-4 h-4" /> Update {selectedIds.length} Members
              </>
            )}
          </button>
        </div>
