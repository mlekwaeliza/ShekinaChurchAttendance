...
const queries = {
  ...
  getMemberTitles: (memberId) => all(`
    SELECT ct.*, mt.assigned_at, u.full_name as assigned_by_name
  ...
  `, [memberId]),
  assignMemberTitle: (memberId, titleId, assignedBy) =>
    run('INSERT OR IGNORE INTO member_titles (member_id, title_id, assigned_by) VALUES (?, ?, ?)', [memberId, titleId, assignedBy]),
